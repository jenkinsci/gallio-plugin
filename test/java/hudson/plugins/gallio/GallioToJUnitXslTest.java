 ...
 * @author Erik Ramfelt
 */
public class GallioToJUnitXslTest {
    @Before
    public void setUp() {
    ...
    public void testTransformation() throws Exception {
        ...
        Transform myTransform = new Transform(new InputSource(this.getClass().getResourceAsStream("Gallio-simple.xml")),
                new InputSource(this.getClass().getResourceAsStream(GallioReportTransformer.GALLIO_TO_JUNIT_XSLFILE_STR)));
    ...
    public void testTransformationFailure() throws Exception {
        ...
        Transform myTransform = new Transform(
                new InputSource(this.getClass().getResourceAsStream("Gallio-failure.xml")), new InputSource(this
                        .getClass().getResourceAsStream(GallioReportTransformer.GALLIO_TO_JUNIT_XSLFILE_STR)));
    ...
    public void testTransformationMultiNamespace() throws Exception {
        ...
        Transform myTransform = new Transform(new InputSource(this.getClass().getResourceAsStream(
                "Gallio-multinamespace.xml")), new InputSource(this.getClass().getResourceAsStream(
                GallioReportTransformer.GALLIO_TO_JUNIT_XSLFILE_STR)));
    ...
    public void testTransformedIgnored() throws Exception {
        Transform myTransform = new Transform(
                new InputSource(this.getClass().getResourceAsStream("Gallio-ignored.xml")), new InputSource(this
                        .getClass().getResourceAsStream(GallioReportTransformer.GALLIO_TO_JUNIT_XSLFILE_STR)));
    ...
    public void testTransformedIssue1077() throws Exception {
        Transform myTransform = new Transform(
                new InputSource(this.getClass().getResourceAsStream("Gallio-issue1077.xml")), new InputSource(this
                        .getClass().getResourceAsStream(GallioReportTransformer.GALLIO_TO_JUNIT_XSLFILE_STR)));
