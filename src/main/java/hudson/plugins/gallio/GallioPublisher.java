...
/**
 * Class that records Gallio test reports into Hudson.
 * 
 * @author Erik Ramfelt
 */
public class GallioPublisher extends hudson.tasks.Publisher implements Serializable {
    ...
    public GallioPublisher(String testResultsPattern, boolean debug, boolean keepJUnitReports, boolean skipJUnitArchiver) {
    ...
    public boolean perform(AbstractBuild<?, ?> build, Launcher launcher, BuildListener listener)
        ...
        if (debug) {
            listener.getLogger().println("Gallio publisher running in debug mode.");
        }
        boolean result = true;
        try {
            ...
            if (result) {
                if (skipJUnitArchiver) {
                    ...
                    result = recordTestResult(GallioArchiver.JUNIT_REPORTS_PATH + "/TEST-*.xml", build, listener);
                }
    ...
    public static class DescriptorImpl extends Descriptor<Publisher> {
        ...
        public String getDisplayName() {
            return "Publish Gallio test result report";
        }

        @Override
        public String getHelpFile() {
            return PLUGIN_GALLIO + "help.html";
        }
        ...
        public Publisher newInstance(StaplerRequest req) throws FormException {
            return new GallioPublisher(req.getParameter("gallio_reports.pattern"), 
                    ...
                    (req.getParameter("gallio_reports.skipjunitarchiver") != null));
        }
    }
}
